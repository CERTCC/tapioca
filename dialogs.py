...
def YesNo(parent=None, question='', caption='Tapioca'):
...
def Info(parent=None, message='', caption='Tapioca'):
    dlg = wx.MessageDialog(
...
def Warn(parent=None, message='', caption='Warning!'):
    dlg = wx.MessageDialog(parent, message, caption, wx.OK | wx.ICON_WARNING)
    dlg.ShowModal()
    dlg.Destroy()


def Ask(parent=None, message='', caption='Tapioca', default_value=''):
