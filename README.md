...
1. Supported platforms include: Raspbian (Jessie or Stretch), Raspberry Pi OS, Debian 10, Centos (7, 8, or Stream 8), RedHat Enterprise Linux 7, Fedora (25 through 33), openSUSE (15.x or Tumbleweed), or Ubuntu (14.04, 16.04, 18.04, or 20.04).   Other platforms may work, but the installer has only been tested on these distros.
1. 1GB of RAM
